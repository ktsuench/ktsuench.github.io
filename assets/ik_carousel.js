;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype.init = function () {
		...
		$elem
			...
			.on('focus mouseenter', {'plugin': plugin}, plugin.stopTimer)
			.on('blur mouseleave', {'plugin': plugin}, plugin.startTimer)
		...
		$controls = $('<div/>')
			.attr({'aria-hidden': 'true'}) // hide controls from screen readers
		...
		plugin.slides = $elem
			...
			.each(function(i, el) {
				...
				$me.attr({'aria-hidden': 'true'}) // hide images from screen readers
